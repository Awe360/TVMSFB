...
const AdminTable = () => {
  ...
  useEffect(() => {
    const fetchAdmins = async () => {
      try {
        const response = await axios.get("https://tvmsb.onrender.com/api/admin/get-all-admin");
  ...
  const handleBlock = async (id) => {
    ...
    try {
    const response= await axios.post("https://tvmsb.onrender.com/api/admin/block-admin", { userId: id }); 
  ...
  const handleUnblock = async (id) => {
    ...
    if (result.isConfirmed) {
    try {
      await axios.post("https://tvmsb.onrender.com/api/admin/unblock-admin", { userId: id });
  ...
  const handleDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.post("https://tvmsb.onrender.com/api/admin/delete", { userId: id });
        setAdmins((prev) => prev.filter((admin) => admin.ID !== id));
        setBlockedAdmins((prev) => prev.filter((admin) => admin.ID !== id));
