...
export default function ProfilePage() {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      const response = await axios.post(
        "https://tvmsb.onrender.com/api/admin/profile/save-profile",
        { userId, email, name }
      );
  ...
  const handleChangePassword = async () => {
    ...
    try {
      const response = await axios.post(
        "https://tvmsb.onrender.com/api/admin/profile/change-password",
  ...
  const saveProfileImage = async (imageUrl) => {
    try {
      const response = await axios.post(
        "https://tvmsb.onrender.com/api/admin/profile/update-photo",
        {
          userId,
